...
private sub submain()
    ...
    a.win1 = ez_window_createex((ezx.display_width -  DEF_WIN1_W_)/2, (ezx.display_height - DEF_WIN1_H_)/2, DEF_WIN1_W_ , DEF_WIN1_H_ , "Demo 17: Pixmaps" , procptr( win1_on_event()  ))
